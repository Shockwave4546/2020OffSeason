...
public class ShockwaveThumbStick {
	Joystick controller;
	XboxAxis xAxis;
	XboxAxis yAxis;
	...
	public ShockwaveThumbStick(Joystick controller, XboxAxis xAxis, XboxAxis yAxis) {
		this.controller = controller;
		this.xAxis = xAxis;
		this.yAxis = yAxis;
	}

	public ShockwaveThumbStick(Joystick controller, XboxAxis xAxis, XboxAxis yAxis, double yDeadband, double xDeadband) {
