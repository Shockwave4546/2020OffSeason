...
public class ShockwaveAxisButton extends Button {
	private final Joystick joy;
	private final int axis;
	private double targetVal;
	private ThresholdType thresholdType;

	public ShockwaveAxisButton(Joystick joystick, int axis, double threshold, ThresholdType thresholdType) {
		this.joy = joystick;
		this.axis = axis;
	...
	public ShockwaveAxisButton(Joystick joystick, XboxAxis axis, double threshold, ThresholdType thresholdType) {
